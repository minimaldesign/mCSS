---
title: "Footer"
description: "Site-wide footer with link columns and a meta area, pure HTML and CSS."
...
| `--footer-*` block in `theme.default.ui.css` | UI tokens (see table below) | [Github][3] |
