...
| `reversed`     | boolean | —       | Visually reverses the content order set by `contentFirst`. (No change to DOM.)           |
| `flush`        | boolean | —       | Removes the outer padding from the content section, making the text flush with the edge. |
