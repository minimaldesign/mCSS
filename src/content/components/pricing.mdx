---
title: "Pricing"
description: "Pricing tier card with feature list and bottom-pinned CTA, built to line up in a pricing table."
...
The `.pricingCard` component is one tier of a pricing table: name, price, feature list, and a CTA pinned to the bottom so a row of tiers lines up. A pricing table is a row of these on the [grid](/docs/layout#grid), with `highlighted` marking the recommended tier.
...
| `--pricingCard-*` block in `theme.default.ui.css`   | UI tokens (see table below)      | [Github][5] |
...
[5]: https://github.com/minimaldesign/mCSS/blob/main/src/styles/framework/theme.default.ui.css
