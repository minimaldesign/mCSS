...
| `--badge-*` block in `theme.default.ui.css` | UI tokens (see table below) | [Github][2] |

</div>

[1]: https://github.com/minimaldesign/mCSS/blob/main/src/styles/framework/component.badge.css
[2]: https://github.com/minimaldesign/mCSS/blob/main/src/styles/framework/theme.default.ui.css
