...
<ul class="docs_examples">
  ...
  <li>
    ...
    <ul class="socialMedia socialMedia-xl">
      <li>
        <a href="https://x.com/_yannb_" target="_blank" rel="noopener noreferrer" aria-label="X">
         <svg>[…]</svg>
        </a>
      </li>
      <li>
        <a href="https://github.com/minimaldesign" target="_blank" rel="noopener noreferrer" aria-label="Github">
         <svg>[…]</svg>
        </a>
      </li>
      <li>
