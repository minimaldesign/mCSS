...
<ul class="docs_examples">
  ...
  <li>
    <Notice title="Information" type="info">
      <p>Notice with the `.notice-info` class.</p>
    </Notice>
  </li>
  <li>
    <Notice title="Something went wrong" type="danger">
      <p>Notice with the `.notice-danger` class.</p>
    </Notice>
  </li>
  <li>
    <Notice title="Attention" type="warning">
      <p>Notice with the `.notice-warning` class.</p>
    </Notice>
  </li>
  <li>
    <Notice title="Success" type="confirm">
      <p>Notice with the `.notice-confirm` class.</p>
    </Notice>
  </li>
</ul>
