---
title: "Testimonial"
description: "Quote with attribution: a figure wrapping a blockquote with an avatar byline."
...
<Testimonial name="Sonny Rollins" role="Design lead, Acme">
  <p>
    We deleted four hundred lines of utility classes the week we switched. The
    cascade does the work now.
  </p>
</Testimonial>
...
| `--testimonial-role-color` in `theme.default.ui.css` | UI token                       | [Github][4] |
...
<Playground
  ...
  controls={[
    ...
    },
    {
      heading: "Byline",
      items: [
        { type: "text", name: "name", label: "Name", default: "Sonny Rollins" },
        {
          type: "text",
          name: "role",
          label: "Role",
          default: "Design lead, Acme",
        },
...
<figure class="testimonial">
  ...
  <figcaption class="testimonial_byline">
    ...
    <div>
      <span class="testimonial_name">Sonny Rollins</span>
...
A wall of quotes is just testimonials on the [grid](/docs/layout#grid):
