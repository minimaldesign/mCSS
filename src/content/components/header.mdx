---
title: "Header"
description: "Site-wide top bar with logo, primary navigation, actions, and a built-in mobile menu."
...
| `--header-*` block in `theme.default.ui.css` | UI tokens (see table below)   | [Github][4] |
