...
<ul class="docs_examples grid grid-flush" col="2">
  ...
  <li><Avatar status="offline" size="xl" imageSrc={imageSrc}>SR</Avatar></li>
  <li><Avatar status="online" size="xl">SR</Avatar></li>
</ul>
...
<ul class="docs_examples">
  ...
  <li>
    <Avatar status="online" size="xl" imageSrc={imageSrc}>Sonny Rollins</Avatar>

    ```html
    <div class="avatar avatar-xl is-online">
      <div>
