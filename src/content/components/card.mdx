...
<Playground
  ...
  snippets={{
    ...
    media: {
      preview: `<figure class="card_media"><img class="card_image" src="${placeholder.src}" alt="Product image" /></figure>`,
      code: `<figure class="card_media"><img class="card_image" src="image.jpg" alt="Product image" /></figure>`,
    },
    actions: {
  ...
  controls={[
    ...
    { heading: "Parts", items: [
      { type: "checkbox", name: "media", label: "Image", snippet: "media", default: false },
