...
| `radius-drawn` | 255px 15px 225px 15px / 15px 225px 15px 255px | <div></div> |
...
[githubShadows]: https://github.com/minimaldesign/mCSS/blob/main/src/styles/settings.tokens.css#L215
