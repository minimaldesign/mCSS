...
<Notice type="info" title="Note" extraClass="mb-sm3">
...
[githubShadows]: https://github.com/minimaldesign/mCSS/blob/main/src/styles/settings.tokens.css#L217
...
| `o-2` | 0.3   | <span class="o-2">Opacity level 2</span> |
| `o-3` | 0.5   | <span class="o-3">Opacity level 3</span> |
| `o-4` | 0.7   | <span class="o-4">Opacity level 4</span> |
