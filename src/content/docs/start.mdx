...
Your own CSS use the same basic [ITCSS][1] technic, but it's unlayered, which means:

- Your CSS has higher specificity than mCSS' (except helpers)
- The order you import your files inside your [global import][4] is important. **Make sure you have a clear mental model of [ITCSS][1] principles before delving in.**
