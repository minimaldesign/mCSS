...
<p>
  Technically, <code>&lt;address&gt;</code> and <code>&lt;h1&gt;</code> —
  <code>&lt;h6&gt;</code> are
  <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element#content_sectioning">
    content sectioning elements
  </a>
  like <code>&lt;header&gt;</code>, <code>&lt;section&gt;</code>, etc. But I
  strive to make mCSS intuitive and easy rather than technically correct, so
  Iʼve included them with the rest of the text elements below.
</p>



<h2 class="docs_heading">Text</h2>

  <section class="docs_section">
    <h3>Address</h3>
    <p>Contact us at:</p>
    <address>
      <a href="mailto:sonny@rollins.com">sonny@rollins.com</a><br />
...
<section class="docs_section">
  ...
  <pre>
    P R E F O R M A T T E D T E X T ! " # $ % &amp; ' ( ) * + , - . / 0 1 2 3 4
...
<h2 class="docs_heading">Table</h2>
...
<h2 class="docs_heading">Form</h2>
<p>
  See
  <a href="https://developer.mozilla.org/en-US/docs/Learn/Forms/How_to_structure_a_web_form">
...
<h2 class="docs_heading">Media</h2>
...
<h2 class="docs_heading">Interactive</h2>
