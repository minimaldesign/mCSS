...
<section class="docs_section prose">
  Technically, `address` and `h1` — `h6` are [content sectioning elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Element#content_sectioning), like `header`, `section`, etc. But I strive to make mCSS intuitive and easy rather than technically correct, so I've included them with the rest of the text elements below.
</section>
...
<section class="docs_section">
  ...
  <address>
    ...
    <br />
    <a href="tel:+19294891434">+1 (929) 489 1434</a>
  </address>
</section>
...
<section class="docs_section prose">
  ...
  <h6>Heading Six</h6>
  <p>A small paragraphe of text to show the heading in context.</p>
  <h1>Consecutive headings get less margin</h1>
...
| `<time>`   | The time element: <time datetime="2013-04-06T12:32+00:00">2 weeks ago</time> |
| `<u>`      | The <u>u element</u> is for non-textual annotation.                          |
...
<section class="docs_section prose">
  <table>
    <caption>Number of albums recorded</caption>
    <thead>
      <tr>
  ...
  <form class="docs_form">
    ...
    <fieldset>
      ...
      <p>
        ...
        <input type="submit" value="Disabled Input" disabled />
      </p>
      <p>
