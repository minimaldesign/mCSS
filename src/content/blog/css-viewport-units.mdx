...
<CanIUse
  feature="css.types.length.viewport_percentage_units_small"
  title="viewport units"
  mdnUrl={mdnLink}
/>

<CanIUse feature="css.types.length.vmin" mdnUrl={mdnLink} />
<CanIUse feature="css.types.length.vmax" mdnUrl={mdnLink} />
