...
**Pro tip:** Tunnels are private by default. If you make your tunnel public for client review, anyone with the link can access it—no login required—but they’ll see a security warning page first and must click through. This isn’t the smoothest experience for non-technical users.
...
<Notice type="warning" title="Heads up" extraClass="mt-md3">
  ...
  sensitive projects, use VS Code and make sure to keep the port private!
</Notice>
