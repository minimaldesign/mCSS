...
<Notice type="warning" title="Heads up" class="mt-md3">
...
Personally, I like Astro Tunnel better. Cloudflare’s tunnel feels faster and it’s simpler to use. But the implementation can be buggy: sometimes the tunnel doesn’t start and I can’t figure out why. If you run into issues, check the [astro-tunnel GitHub issues](https://github.com/morinokami/astro-tunnel/issues) or try restarting your dev server.
