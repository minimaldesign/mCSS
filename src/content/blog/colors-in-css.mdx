...
<div
  class="mb-sm2 p-sm2"
  style="border-radius: var(--radius-sm); background: linear-gradient(90deg,  #ff00ff,#00ff00);">sRGB</div>
<div
  class="mb-sm2 p-sm2"
  style="border-radius: var(--radius-sm); background: linear-gradient(in oklab  90deg,  #ff00ff,#00ff00);">Oklab</div>
<div
  class="mb-md2 p-sm2"
  style="border-radius: var(--radius-sm); background: linear-gradient(in oklch  90deg, #ff00ff,#00ff00);">OKLCH</div>
